...
PRO seab_checkdupes_multi_2016a, temp_filename, loglun, class_array, line_number, found_error, good_record_counter
...
PRINT, '---->entering f_checkdupes_multi_2016a'
...
PRINT, '---->leaving f_checkdupes_multi_2016a'
